    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            case 6: 
                ...
                if (type==1) {
                    System.out.println("Entrer le frais");
            ...
            case 7:
                List<Compte> comptes= compteService.listerCompte();
                    for (Compte cpte : comptes) {
                        System.out.println("Numero "+ cpte.getNum());
                        System.out.println("Solde "+ cpte.getSolde());
                        System.out.println("Type "+ cpte.getType());
                        System.out.println("Client "+ cpte.getClient().getNom()+" "+cpte.getClient().getPrenom()+" "+cpte.getClient().gettel());
                        System.out.println("*******************************************");
                    }
            break;
            case 8:
